...
public:
	...
	virtual void	Unk_52(void);		// GetEquippedWeapon it seems (unk0114)
...
public:
	...
	UInt32					unk118;			// 118  EntryData, also handled as part of weapon code. AmmoInfo.
	Unk11C*					unk11C;			// 11C
	Unk11C*					unk120;			// 120
	...
	Unk138*					unk138;			// 138	its an animation. Current Animation?
