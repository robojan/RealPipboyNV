...
public:
	...
	virtual NiObject *	CastAsNiNode(void);	// NiNode returns 'this'
...
public:
	...
	virtual int	Seek(FILE *stream, size_t offset, int origin);			// 14
...
public:
	...
	DEFINE_MEMBER_FN(ReadFile, int, 0xb00650, void* dst, UInt32 size);
};
