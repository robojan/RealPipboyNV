...
struct ModInfo		// referred to by game as TESFile
{
	...
	DEFINE_MEMBER_FN(GetFileVersion, float, 0x4694C0);
	DEFINE_MEMBER_FN(GetFileName, char *, 0x891170);
	DEFINE_MEMBER_FN(GetDataBuffer, void *, 0x473930);
	DEFINE_MEMBER_FN(GetNextGRUP, bool, 0x4726F0);
#endif
};
